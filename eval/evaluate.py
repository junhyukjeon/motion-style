...
from eval.dataset import Text2MotionTestDataset
from eval.metrics import TM2TMetrics
from eval.evaluator_wrapper import StyleClassification
...
def collate_fn(batch):
    ...
    batch_len = len(notnone_batches[0]) # Length of the tuple per sample
