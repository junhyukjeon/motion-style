...
if __name__ == "__main__":
    ...
    reconstruct_dir = os.path.join(config["result_dir"], "reconstruct")
    ...
    for batch_ids in tqdm(batched_indices, desc="Reconstructing motions"):
        motions, motion_ids = [], []
        ...
        for i, motion_id in enumerate(motion_ids):
            ...
            save_path = get_unique_path(os.path.join(reconstruct_dir, f"{motion_id}_reconstructed.npy"))
