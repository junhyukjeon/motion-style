...
def plot_3d_motion(save_path, kinematic_tree, joints, title, dataset, figsize=(3, 3), fps=120, radius=3,
    ...
    elif dataset in ['humanml', '100style']:
...
def plot_3d_motion_with_trajectories(save_path, kinematic_tree, joints, title, dataset, figsize=(3, 3), fps=120, radius=3,
    ...
    return explicit_plot_3d_motion(save_path, kinematic_tree, joints, title, dataset, figsize=figsize, fps=fps, radius=radius, vis_mode=vis_mode, frame_colors=frame_colors, joints2=joints2, painting_features=painting_features)
